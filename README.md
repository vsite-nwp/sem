...
| student | rad | 
|---|---|
| Bruno Baburić         | sudoku |
| Domagoj Birkić        | šah |
| Viktor Mihovil Kronja | tic-tac-toe |
| Damir Magdić          | taktičke postavke u nogometu |
| Matej Marinković      | video editor |
| Ivan Pijević          | space invaders (OpenGL) |
| Rudolf Raspudić       | vizualizacija A* algoritma |
